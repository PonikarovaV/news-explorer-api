module.exports.VALIDATION_ERRORS = {
  nameSchemaError: 'Поле name обязательно для заполнения. Имя может содержать символы А-Я, A-Z в верхнем или нижнем регистре, цифры и пробел. Количество символов от 2 до 30.',
  ...
  signupFieldsError: 'Логин и пароль обязательны для заполнения и должны быть корректно заполнены. Пароль может содержать символы A-Z в верхнем или нижнем регистре, цифры и *. Количество символов в пароле от 8 до 30 символов.',
...
module.exports.REGEXP_PATTERNS = {
  nameRegexp: /^[a-zA-Zа-яёА-ЯЁ0-9\s]{2,30}$/m,
  passwordRegexp: /^[a-zA-Z0-9*]{8,30}$/m
};
